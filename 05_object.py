...
# hello = "안녕하세요~!"
# emoji = "♥"
# empty = ""  # 따옴표만 있고, 아무것도 작서되지 않아도 Str
# fake_num = "12345"
# fake_num2 = "5.0"
...
# type() - 자료형 확인
# type(확인하고자 하는 것) > 입력한 것의 자료혀을 알려줌

# type(5)  # 터미널에서 화긴 불가 > print하지 않았기 떄문
...
# 4. 3 > 2의 연산 결과는 True이기 떄문어 type(True)로 바뀜
...
# # 내가 터미널에서 출력된 결과 중에서
# # type()을 사용해서 자료형을 확인한 결과를 쉽게 확인 할 수 있는 방법
# print("num, >>>", type(num))  # num >>> <class 'int'>
# print("num, :", type(num))  # num : <class 'int'>

# ====================
# print("=== 자료형 마다 동작이 다른 것 확인하기===")
...
# # =======================
# print("==== 자주 하는 실수====")
# print(0.1 + 0.8) # 0.9 출력되지만 가끔 컴퓨터 내부 연산 과정에서 아주 작은 오차가 발생하는 경우도 있음
